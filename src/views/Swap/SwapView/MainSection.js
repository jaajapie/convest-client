        ...
        <MainSectionArea>
            <InnerSectionArea>
                ...
                <InnerRightSectionArea>
                    <ReceiveValueArea>
                        <InputLabel shrink htmlFor="bootstrap-input">You receive </InputLabel>
                        <ReceiveValueCenterArea>
                            <InputLabel shrink htmlFor="bootstrap-input">0 </InputLabel>
                            <InputLabel shrink htmlFor="bootstrap-input">NXM </InputLabel>
                        </ReceiveValueCenterArea>
                    ...
                    <InfoArea>
                        <InfoDetailArea>
                            <InputLabel shrink htmlFor="bootstrap-input">Rate: </InputLabel>
                            <LabelRightText>1 NXM ~ 0.0332 ETH </LabelRightText>
                        </InfoDetailArea>
                        <InfoDetailArea>
                            <InputLabel shrink htmlFor="bootstrap-input">Inverse rate: </InputLabel>
                            <LabelRightText>1ETH ~ 30.0634 NXM </LabelRightText>
                        </InfoDetailArea>
                        <InfoDetailArea>
                            <InputLabel shrink htmlFor="bootstrap-input">Slippage tolerance: </InputLabel>
                        ...
                        <InfoDetailArea>
                            <InputLabel shrink htmlFor="bootstrap-input">Minimum received: </InputLabel>
